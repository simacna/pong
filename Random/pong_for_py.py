...
#these 4 lines were commented out, uncommenting to see why..
...
def draw_handler(canvas):
    ...
    if paddle1_pos+paddle1_vel >= 0.1*HALF_PAD_HEIGHT and paddle1_pos+paddle1_vel < HEIGHT - 2*HALF_PAD_HEIGHT :
